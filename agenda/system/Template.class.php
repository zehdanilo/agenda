...
namespace danilo\view {
	...
	class Template {
		...
		*/
		...
		/**
		 * Check if a template block exists.
		 *
		 * This method returns true if the template block exists. Otherwise, false.
		 *
		 * @param	string	$varname	template block name
		 */
		public function existsBlock($block){
